...
const simpleSettlementOverlay = document.getElementById('simple-settlement-overlay');
const simpleSettlementKicker = document.getElementById('simple-settlement-kicker');
const simpleSettlementTitle = document.getElementById('simple-settlement-title');
const simpleSettlementSubtitle = document.getElementById('simple-settlement-subtitle');
const simpleSettlementOpenedCount = document.getElementById('simple-settlement-opened-count');
const simpleSettlementBurst = document.getElementById('simple-settlement-burst');
const simpleSettlementReward = document.getElementById('simple-settlement-reward');
const simpleSettlementEncore = document.getElementById('simple-settlement-encore');
const simpleSettlementWishHits = document.getElementById('simple-settlement-wish-hits');
const simpleSettlementNextBtn = document.getElementById('simple-settlement-next-btn');
